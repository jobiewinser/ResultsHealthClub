...
urlpatterns = [
    ...
    path('add-contact/', coreviews.edit_contact, name='add-contact' ),
    path('edit-contact/', coreviews.edit_contact, name='edit-contact' ),
    ...
    path('configuration/deactivate-site/', coreviews.deactivate_site, name='deactivate-site'),  
