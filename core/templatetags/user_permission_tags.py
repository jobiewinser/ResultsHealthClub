...
@register.filter
def get_profile_allowed_to_edit_active_campaign_settings_tag(profile, company):
    return get_profile_allowed_to_edit_active_campaign_settings(profile, company)
@register.filter
